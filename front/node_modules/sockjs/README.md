...
You need to start a second web server (by default listening on 8088)
...
8081 and sockjs-client on 8088. When you open the browser on
[http://localhost:8088/](http://localhost:8088/) you should be able
