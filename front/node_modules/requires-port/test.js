describe('requires-port', function () {
  ...
  it('never requires port numbers for file', function () {
    assume(required(8088, 'file')).false();
  });
  ...
  it('does not require port 80 for http', function () {
    ...
    assume(required('8088', 'http')).true();
    assume(required(8088, 'http')).true();
    assume(required(8088, 'http://')).true();
    assume(required(8088, 'http://www.google.com')).true();
  });
  ...
  it('does not require port 80 for ws', function () {
    ...
    assume(required('8088', 'ws')).true();
    assume(required(8088, 'ws')).true();
    assume(required(8088, 'ws://')).true();
    assume(required(8088, 'ws://www.google.com')).true();
  });
  ...
  it('does not require port 443 for https', function () {
    ...
    assume(required('8088', 'https')).true();
    assume(required(8088, 'https')).true();
    assume(required(8088, 'https://')).true();
    assume(required(8088, 'https://www.google.com')).true();
  });
  ...
  it('does not require port 443 for wss', function () {
    ...
    assume(required('8088', 'wss')).true();
    assume(required(8088, 'wss')).true();
    assume(required(8088, 'wss://')).true();
    assume(required(8088, 'wss://www.google.com')).true();
  });
  ...
  it('does not require port 21 for ftp', function () {
    ...
    assume(required('8088', 'ftp')).true();
    assume(required(8088, 'ftp')).true();
    assume(required(8088, 'ftp://')).true();
    assume(required(8088, 'ftp://www.google.com')).true();
  });
  ...
  it('does not require port 70 for gopher', function () {
    ...
    assume(required('8088', 'gopher')).true();
    assume(required(8088, 'gopher')).true();
    assume(required(8088, 'gopher://')).true();
    assume(required(8088, 'gopher://www.google.com')).true();
  });
});
